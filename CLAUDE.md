...
- **Run**: `cargo run`
- **Build**: `cargo build`
- **Scale**: 17 files, 1947 LOC [config(1), rust(16)]

### Directory structure
```
src/ (10 files, 3068 LOC)
tests/ (6 files, 790 LOC)  [common(1)]
```
...
- `src/main.rs` (269 LOC, rust)  — 17:struct Cli; 23:enum Commands; 89:enum MapArg; 95:impl impl MapArg; 96:fn into_profile; 106:enum Format; 112:fn now_iso; 129:fn civil_from_days; 142:fn analyze; 183:fn main
- `src/explore.rs` (192 LOC, rust)  — 9:const TRACK_SECTION; 12:struct CoverageRow; 19:struct ExploreMetrics; 32:fn est_tokens_from_loc; 36:fn compute; 40:fn compute_with_profile; 82:fn render; 116:fn row_md; 135:fn track_update; 207:fn track_append
...
- `tests/claudecat.rs` (179 LOC, rust)  — 5:fn manifest_detects_rust_and_deps; 18:fn symbols_extract_rust_items; 28:fn symbols_skip_nested_fn_noise; 39:fn claude_md_update_is_idempotent_and_atomic; 54:fn temp_project; 61:fn rand_suffix; 67:fn guardrails_preserved_and_seeded; 87:fn guardrails_load_from_file; 96:fn explore_report_has_savings_section; 115:fn claudecat_lib_scan; 126:fn track_appends_and_updates_same_day_row; 147:fn auto_profile_picks_mini_for_small_project; 161:fn auto_profile_picks_full_for_large_project; 176:fn track_update_handles_multiple_repos
- `src/outline.rs` (149 LOC, rust)  — 5:fn render_markdown; 9:fn render_with_profile; 16:fn render_full; 117:fn render_mini
- `src/model.rs` (85 LOC, rust)  — 5:struct ProjectMeta; 18:struct Symbol; 25:struct FileInfo; 33:struct DepGroup; 39:struct DirStat; 45:struct ProjectMap; 63:enum MapProfile; 71:impl impl MapProfile; 72:fn is_mini; 78:fn resolve_profile
...
*Generated at 2026-09-04T17:00:22Z by claudecat* — facts from manifests + AST, no inference.
<!-- claudecat:auto:end -->
