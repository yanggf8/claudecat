...
- **Run**: `cargo run`
- **Build**: `cargo build`
- **Scale**: 19 files, 2705 LOC [config(1), rust(18)]

### Directory structure
```
src/ (12 files, 2212 LOC)
tests/ (6 files, 493 LOC)  [common(1)]
Total: 18 files, 2705 LOC (code)
```
...
- `src/cort.rs` (222 LOC, rust)  — 10:fn project_id; 21:fn cache_dir; 30:fn db_path_for; 35:struct CortIndexInfo; 48:struct CortHit; 58:struct CortDependent; 67:fn open_readonly; 76:fn index_info; 131:fn freshness; 151:fn git_head; 168:fn search_symbols; 204:fn dependents
...
- `src/navigate.rs` (210 LOC, rust)  — 11:struct NavigateHit; 20:struct NavigateResult; 28:fn tokens; 37:fn symbol_matches; 43:fn navigate; 119:fn render; 156:fn navigate_with_cort; 214:fn render_dependents
...
- `crates.io`: clap, ignore, rusqlite, serde, serde_json, sha2, tempfile, toml, tree-sitter, tree-sitter-c, tree-sitter-cpp, tree-sitter-go, tree-sitter-javascript, tree-sitter-python, tree-sitter-rust, tree-sitter-typescript

*Generated at 2026-09-05T03:00:08Z by claudecat* — facts from manifests + AST; framework/entry may be inferred from deps/paths where manifest lacks them.
<!-- claudecat:auto:end -->
